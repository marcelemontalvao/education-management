...
This directory contains the database schema and seed data for the Education Management System. The system uses PostgreSQL as the primary database with a comprehensive schema designed for educational institution management.
